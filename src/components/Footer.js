			...
			<div className="row text-center text-xs-center text-sm-left text-md-left">
				...
				<div className="col-xs-4 col-sm-4 col-md-4">
					...
					<ul className="list-unstyled quick-links">
						...
						<li><a href="#"><i className="fa fa-angle-double-right"></i>Twitter</a></li>
						<li><a href="#"><i className="fa fa-angle-double-right"></i>System Status</a></li>
					</ul>
				</div>
				<div className="col-xs-4 col-sm-4 col-md-4">
					<h5>Quick links</h5>
					<ul className="list-unstyled quick-links">
						...
						<li><a href="#"><i className="fa fa-angle-double-right"></i>List Marker</a></li>
						<li><a href="#"><i className="fa fa-angle-double-right"></i>Online Notedpad</a></li>
					</ul>
				</div>
			</div>	
			<div className="row">
